...
|---|---|---|---|
| M0 | Engineering and architecture harness | CI, `AGENTS.md`, ADR-021, checked-in coverage ratchet, C001-C008 | In progress until Issue #3 and harness-hardening sub-issues satisfy acceptance |
